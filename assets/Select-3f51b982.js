import{c4 as Xe,dY as Ue,K as be,cb as fn,d as Fe,s as r,bn as hn,d5 as Ce,dZ as en,br as qe,bI as Un,aM as vn,al as x,aw as M,am as U,ak as ne,an as Ze,c9 as gn,p as Oe,aq as nn,as as bn,bp as j,d_ as qn,q as S,c as P,d$ as Gn,bw as Yn,at as ge,ax as Ie,aN as on,au as tn,a3 as ln,aL as Qn,N as Zn,bP as Jn,b$ as pn,e0 as Be,e1 as Xn,e2 as et,Q as nt,e3 as rn,e4 as tt,F as ot,e5 as lt,e6 as it,bq as an,aK as rt,e7 as at,bH as st,bo as dt,cc as ut,cd as Je,ce as ct,cf as ft,cg as ht,d9 as vt,da as gt,dS as sn,e8 as bt,dR as pt,ay as ee}from"./index-bd50fbe2.js";import{N as Ge}from"./Tag-e3e818de.js";import{F as mt}from"./FocusDetector-3a11b0cd.js";import{V as wt}from"./VirtualList-14091d8c.js";import{N as yt}from"./Empty-eb53eddc.js";import{m as xt}from"./index-cbfaa337.js";function mn(e,a){a&&(Xe(()=>{const{value:s}=e;s&&Ue.registerHandler(s,a)}),be(e,(s,d)=>{d&&Ue.unregisterHandler(d)},{deep:!1}),fn(()=>{const{value:s}=e;s&&Ue.unregisterHandler(s)}))}function dn(e){switch(typeof e){case"string":return e||void 0;case"number":return String(e);default:return}}function Ye(e){const a=e.filter(s=>s!==void 0);if(a.length!==0)return a.length===1?a[0]:s=>{e.forEach(d=>{d&&d(s)})}}const Ct=Fe({name:"Checkmark",render(){return r("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16"},r("g",{fill:"none"},r("path",{d:"M14.046 3.486a.75.75 0 0 1-.032 1.06l-7.93 7.474a.85.85 0 0 1-1.188-.022l-2.68-2.72a.75.75 0 1 1 1.068-1.053l2.234 2.267l7.468-7.038a.75.75 0 0 1 1.06.032z",fill:"currentColor"})))}}),un=Fe({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:a,labelFieldRef:s,nodePropsRef:d}=hn(en);return{labelField:s,nodeProps:d,renderLabel:e,renderOption:a}},render(){const{clsPrefix:e,renderLabel:a,renderOption:s,nodeProps:d,tmNode:{rawNode:f}}=this,v=d?.(f),h=a?a(f,!1):Ce(f[this.labelField],f,!1),i=r("div",Object.assign({},v,{class:[`${e}-base-select-group-header`,v?.class]}),h);return f.render?f.render({node:i,option:f}):s?s({node:i,option:f,selected:!1}):i}});function Ot(e,a){return r(vn,{name:"fade-in-scale-up-transition"},{default:()=>e?r(Un,{clsPrefix:a,class:`${a}-base-select-option__check`},{default:()=>r(Ct)}):null})}const cn=Fe({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:a,pendingTmNodeRef:s,multipleRef:d,valueSetRef:f,renderLabelRef:v,renderOptionRef:h,labelFieldRef:i,valueFieldRef:k,showCheckmarkRef:N,nodePropsRef:O,handleOptionClick:E,handleOptionMouseEnter:R}=hn(en),C=qe(()=>{const{value:T}=s;return T?e.tmNode.key===T.key:!1});function w(T){const{tmNode:F}=e;F.disabled||E(T,F)}function _(T){const{tmNode:F}=e;F.disabled||R(T,F)}function K(T){const{tmNode:F}=e,{value:z}=C;F.disabled||z||R(T,F)}return{multiple:d,isGrouped:qe(()=>{const{tmNode:T}=e,{parent:F}=T;return F&&F.rawNode.type==="group"}),showCheckmark:N,nodeProps:O,isPending:C,isSelected:qe(()=>{const{value:T}=a,{value:F}=d;if(T===null)return!1;const z=e.tmNode.rawNode[k.value];if(F){const{value:D}=f;return D.has(z)}else return T===z}),labelField:i,renderLabel:v,renderOption:h,handleMouseMove:K,handleMouseEnter:_,handleClick:w}},render(){const{clsPrefix:e,tmNode:{rawNode:a},isSelected:s,isPending:d,isGrouped:f,showCheckmark:v,nodeProps:h,renderOption:i,renderLabel:k,handleClick:N,handleMouseEnter:O,handleMouseMove:E}=this,R=Ot(s,e),C=k?[k(a,s),v&&R]:[Ce(a[this.labelField],a,s),v&&R],w=h?.(a),_=r("div",Object.assign({},w,{class:[`${e}-base-select-option`,a.class,w?.class,{[`${e}-base-select-option--disabled`]:a.disabled,[`${e}-base-select-option--selected`]:s,[`${e}-base-select-option--grouped`]:f,[`${e}-base-select-option--pending`]:d,[`${e}-base-select-option--show-checkmark`]:v}],style:[w?.style||"",a.style||""],onClick:Ye([N,w?.onClick]),onMouseenter:Ye([O,w?.onMouseenter]),onMousemove:Ye([E,w?.onMousemove])}),r("div",{class:`${e}-base-select-option__content`},C));return a.render?a.render({node:_,option:a,selected:s}):i?i({node:_,option:a,selected:s}):_}}),Ft=x("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
