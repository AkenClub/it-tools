import{o as a,s as r,v as t,d as l,bb as d,bc as c,e as m,f as s,ba as h}from"./index-8a14065c.js";const u={class:"markdown-body"},f=t("pre",null,[t("code",{class:"language-bash"},`#!/bin/bash
##############################################################################
...
`)],-1),p=[f],b={__name:"bash-memo.content",setup(i,{expose:e}){return e({frontmatter:{}}),(o,y)=>(a(),r("div",u,p))}},g=l({__name:"bash-memo",setup(i){d(n=>({"51c1c15c":s(e).cardColor}));const e=c();return(n,o)=>(a(),r("div",null,[m(s(b))]))}});const w=h(g,[["__scopeId","data-v-31e2d9a3"]]);export{w as default};
