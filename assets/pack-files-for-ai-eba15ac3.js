import{T as W}from"./TextareaCopyable-307e7842.js";import{d as q,aa as Q,q as T,ab as f,o as X,b as J,w as s,e as a,G as d,H as g,f as t,i as p,ai as K,aU as Y}from"./index-bd50fbe2.js";import{_ as Z,N as ee}from"./Upload-39298443.js";import{_ as te}from"./RadioButton-f7055384.js";import{_ as oe}from"./text-2127310f.js";import{_ as ae}from"./Checkbox-f8e2aa2b.js";import{_ as ne}from"./Space-f47a7ce8.js";import{_ as se}from"./Tree-977da80c.js";import{_ as ie}from"./FormItem-aa64989f.js";import{_ as le}from"./Card-e6725c49.js";import{_ as re}from"./RadioGroup-190680b5.js";import"./base64-11d7ac16.js";import"./index-a6f01dde.js";import"./downloadBase64-2afed79b.js";import"./index-59cddc9a.js";import"./index-dbbd6507.js";import"./Copy-e5e09d26.js";import"./Scrollbar-bc5b5dc5.js";import"./Progress-4bfb6439.js";import"./Image-25d5856c.js";import"./_arrayReduce-865b0d3f.js";import"./download-953ccaa2.js";import"./get-slot-1efb97e5.js";import"./Empty-eb53eddc.js";import"./VirtualList-14091d8c.js";import"./context-206942e2.js";const Be=q({__name:"pack-files-for-ai",setup(ce){const{t:l}=Q(),U=T([]),j=T([]),h=f({name:"fmt",storageName:"pack-ai:f",defaultValue:"markdown"}),y=f({name:"incl",storageName:"pack-ai:i",defaultValue:""}),b=f({name:"excl",storageName:"pack-ai:e",defaultValue:""}),k=f({name:"summary",storageName:"pack-ai:s",defaultValue:!0}),v=f({name:"dirstruct",storageName:"pack-ai:d",defaultValue:!0}),x=f({name:"linenums",storageName:"pack-ai:l",defaultValue:!1}),w=f({name:"empty",storageName:"pack-ai:y",defaultValue:!1}),$=f({name:"comments",storageName:"pack-ai:c",defaultValue:!1}),S=T(!1),N=T("");function D({fileList:o}){U.value=o,j.value=I(o)}function C(o,e=""){return Object.entries(o).map(([r,i])=>({label:r,key:e+r,children:i?C(i,`${e+r}/`):void 0}))}function _(o){return(o.fullPath||o.name).replace(/^[/\\]/g,"")}function I(o){const e={};return o.forEach(r=>{const i=_(r).split("/");let n=e;i.forEach((u,m)=>{n[u]||(n[u]=m===i.length-1?null:{}),n=n[u]})}),C(e)}async function A(){const o=U.value.filter(e=>{const r=_(e),i=y.value?new RegExp(y.value).test(r):!0,n=b.value?new RegExp(b.value).test(r):!1;return i&&!n});h.value==="xml"?N.value=await G(o):N.value=await M(o)}async function P(o){const e=await o.file?.text?.()||"";return L(e,o.name.split(".").slice(-1)[0]||"txt",{numberLines:x.value,removeEmptyLines:w.value,removeComments:$.value})}async function G(o){const e=`
