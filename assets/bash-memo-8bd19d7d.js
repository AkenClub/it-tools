import{o as a,m as r,n as t,d as l,bj as d,bk as c,e as m,f as s,bi as h}from"./index-bd50fbe2.js";const u={class:"markdown-body"},f=t("pre",null,[t("code",{class:"language-bash"},`#!/bin/bash
##############################################################################
...
`)],-1),p=[f],g={__name:"bash-memo.content",setup(i,{expose:e}){return e({frontmatter:{}}),(o,y)=>(a(),r("div",u,p))}},b=l({__name:"bash-memo",setup(i){d(n=>({"51c1c15c":s(e).cardColor}));const e=c();return(n,o)=>(a(),r("div",null,[m(s(g))]))}});const w=h(b,[["__scopeId","data-v-31e2d9a3"]]);export{w as default};
