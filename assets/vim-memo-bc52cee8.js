import{o,m as a,n as t,d as c,bj as l,bk as d,e as u,f as r,bi as h}from"./index-bd50fbe2.js";const p={class:"markdown-body"},w=t("pre",null,[t("code",null,`##############################################################################
# VIM CHEATSHEET
...
`)],-1),m=[w],f={__name:"vim-memo.content",setup(i,{expose:e}){return e({frontmatter:{}}),(s,b)=>(o(),a("div",p,m))}},g=c({__name:"vim-memo",setup(i){l(n=>({"6a1a5c93":r(e).cardColor}));const e=d();return(n,s)=>(o(),a("div",null,[u(r(f))]))}});const k=h(g,[["__scopeId","data-v-da0c6205"]]);export{k as default};
