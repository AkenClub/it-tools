import{al as c,am as d,aw as o,ak as n,an as O,d as j,p as v,c as h,at as u,aq as H,as as T,au as V,s as l,a3 as L,aF as M}from"./index-bd50fbe2.js";import{s as N,r as W}from"./RadioGroup-190680b5.js";const q=c("radio",`
...
`,[d("checked",[o("dot",`
 ...
 cursor: not-allowed;
 `)])]),K=Object.assign(Object.assign({},v.props),W),J=j({name:"Radio",props:K,setup(a){const e=N(a),i=v("Radio","-radio",q,M,a,e.mergedClsPrefix),s=h(()=>{const{mergedSize:{value:b}}=e,{common:{cubicBezierEaseInOut:x},self:{boxShadow:w,boxShadowActive:m,boxShadowDisabled:z,boxShadowFocus:k,boxShadowHover:C,color:S,colorDisabled:R,colorActive:_,textColor:y,textColorDisabled:$,dotColorActive:D,dotColorDisabled:P,labelPadding:B,labelLineHeight:E,labelFontWeight:F,[u("fontSize",b)]:A,[u("radioSize",b)]:I}}=i.value;return{"--n-bezier":x,"--n-label-line-height":E,"--n-label-font-weight":F,"--n-box-shadow":w,"--n-box-shadow-active":m,"--n-box-shadow-disabled":z,"--n-box-shadow-focus":k,"--n-box-shadow-hover":C,"--n-color":S,"--n-color-active":_,"--n-color-disabled":R,"--n-dot-color-active":D,"--n-dot-color-disabled":P,"--n-font-size":A,"--n-radio-size":I,"--n-text-color":y,"--n-text-color-disabled":$,"--n-label-padding":B}}),{inlineThemeDisabled:t,mergedClsPrefixRef:f,mergedRtlRef:p}=H(a),g=T("Radio",p,f),r=t?V("radio",h(()=>e.mergedSize.value[0]),s,a):void 0;return Object.assign(e,{rtlEnabled:g,cssVars:t?void 0:s,themeClass:r?.themeClass,onRender:r?.onRender})},render(){const{$slots:a,mergedClsPrefix:e,onRender:i,label:s}=this;return i?.(),l("label",{class:[`${e}-radio`,this.themeClass,this.rtlEnabled&&`${e}-radio--rtl`,this.mergedDisabled&&`${e}-radio--disabled`,this.renderSafeChecked&&`${e}-radio--checked`,this.focus&&`${e}-radio--focus`],style:this.cssVars},l("input",{ref:"inputRef",type:"radio",class:`${e}-radio-input`,value:this.value,name:this.mergedName,checked:this.renderSafeChecked,disabled:this.mergedDisabled,onChange:this.handleRadioInputChange,onFocus:this.handleRadioInputFocus,onBlur:this.handleRadioInputBlur}),l("div",{class:`${e}-radio__dot-wrapper`}," ",l("div",{class:[`${e}-radio__dot`,this.renderSafeChecked&&`${e}-radio__dot--checked`]})),L(a.default,t=>!t&&!s?null:l("div",{ref:"labelRef",class:`${e}-radio__label`},t||s)))}});export{J as _};
