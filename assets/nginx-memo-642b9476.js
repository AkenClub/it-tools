import{o,s as r,v as s,d as l,bb as m,bc as p,e as c,f as t,ba as d}from"./index-8a14065c.js";const _={class:"markdown-body"},u=s("pre",null,[s("code",{class:"language-bash"},`##############################################################################
# NGINX
...
`)],-1),x=[u],v={__name:"nginx-memo.content",setup(a,{expose:n}){return n({frontmatter:{}}),(i,g)=>(o(),r("div",_,x))}},h=l({__name:"nginx-memo",setup(a){m(e=>({"5c62344e":t(n).cardColor}));const n=p();return(e,i)=>(o(),r("div",null,[c(t(v))]))}});const w=d(h,[["__scopeId","data-v-36391df5"]]);export{w as default};
