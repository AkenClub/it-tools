import{d as H,a9 as F,y as $,c as V,o as U,s as W,e as d,f as m,i as j,w as G,j as X}from"./index-8a14065c.js";import{T as Y}from"./TextareaCopyable-c541a0c9.js";import{_ as K}from"./Divider-ec0652bc.js";import{_ as z}from"./FormItem-18f69a57.js";import"./base64-11d7ac16.js";import"./index-a6f01dde.js";import"./downloadBase64-a22fcbde.js";import"./index-0862b35f.js";import"./index-af76eecf.js";import"./Copy-c54f42f9.js";import"./Scrollbar-a18b0812.js";import"./use-form-item-e9bddaa3.js";import"./context-6debdef3.js";function q(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)r.hasOwnProperty(n)&&(e[n]=r[n])}return e}function A(e,t){return Array(t+1).join(e)}function Q(e){return e.replace(/^\n*/,"")}function J(e){for(var t=e.length;t>0&&e[t-1]===`
`;)t--;return e.substring(0,t)}var Z=["ADDRESS","ARTICLE","ASIDE","AUDIO","BLOCKQUOTE","BODY","CANVAS","CENTER","DD","DIR","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","FRAMESET","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","HTML","ISINDEX","LI","MAIN","MENU","NAV","NOFRAMES","NOSCRIPT","OL","OUTPUT","P","PRE","SECTION","TABLE","TBODY","TD","TFOOT","TH","THEAD","TR","UL"];function T(e){return E(e,Z)}var w=["AREA","BASE","BR","COL","COMMAND","EMBED","HR","IMG","INPUT","KEYGEN","LINK","META","PARAM","SOURCE","TRACK","WBR"];function B(e){return E(e,w)}function ee(e){return x(e,w)}var O=["A","TABLE","THEAD","TBODY","TFOOT","TH","TD","IFRAME","SCRIPT","AUDIO","VIDEO"];function te(e){return E(e,O)}function re(e){return x(e,O)}function E(e,t){return t.indexOf(e.nodeName)>=0}function x(e,t){return e.getElementsByTagName&&t.some(function(r){return e.getElementsByTagName(r).length})}var s={};s.paragraph={filter:"p",replacement:function(e){return`

`+e+`

`}};s.lineBreak={filter:"br",replacement:function(e,t,r){return r.br+`
`}};s.heading={filter:["h1","h2","h3","h4","h5","h6"],replacement:function(e,t,r){var n=Number(t.nodeName.charAt(1));if(r.headingStyle==="setext"&&n<3){var i=A(n===1?"=":"-",e.length);return`
...
`).replace(/\n/g," "),e=e.replace(/\|/g,"\\|"),n+e+" |"}function P(e,t){var r=e.getAttribute("colspan")||1;return r<=1?"":(" "+t+" |").repeat(r-1)}function I(e){for(var t=e.parentNode;t;){if(t.nodeName==="TABLE")return!0;t=t.parentNode}return!1}function be(e){e.keep(function(r){return r.nodeName==="TABLE"&&I(r)});for(var t in f)e.addRule(t,f[t])}function Re(e){e.addRule("taskListItems",{filter:function(t){return t.type==="checkbox"&&t.parentNode.nodeName==="LI"},replacement:function(t,r){return(r.checked?"[x]":"[ ]")+" "}})}function we(e){e.use([Te,Ee,be,Re])}const Ve=H({__name:"html-to-markdown",setup(e){const{t}=F(),r=new g;we(r);const n=$(""),i=V(()=>{try{return r.turndown(n.value??"")}catch(a){return a.toString()}});return(a,o)=>{const u=X,l=K,c=z;return U(),W("div",null,[d(u,{value:m(n),"onUpdate:value":o[0]||(o[0]=p=>j(n)?n.value=p:null),multiline:"","raw-text":"",placeholder:m(t)("tools.html-to-markdown.texts.placeholder-your-html-content"),rows:"8",autofocus:"",label:m(t)("tools.html-to-markdown.texts.label-your-html-to-convert-can-paste-from-clipboard"),"paste-html":""},null,8,["value","placeholder","label"]),d(l),d(c,{label:m(t)("tools.html-to-markdown.texts.label-output-markdown")},{default:G(()=>[d(Y,{value:m(i)},null,8,["value"])]),_:1},8,["label"])])}}});export{Ve as default};
